    ...
    <form action="<?= base_url() ?>barang/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                ...
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Tambah Kerja</h1>
            </div>
            ...
            <div class="col-lg-8 mb-4">
                ...
                <div class="card border-bottom-secondary shadow mb-4">
                    <div class="card-header py-3 bg-secondary">
                        <h6 class="m-0 font-weight-bold text-white">Form Kerja</h6>
                    </div>
                    <div class="card-body">
                        <div class="col-lg-12">
                            <!-- Nama Barang -->
                            <div class="form-group"><label>Nama Kerja</label>
                            ...
                            <!-- jenis -->
                            <?php if($jmlJenis > 0): ?>
                            <div class="form-group"><label>Jenis Divisi</label>
                            ...
                            <div class="form-group"><label>Satuan Kerja</label>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <span class="text-danger"><i>(Belum Ada Data Klasifikasi Kerja!)</i></span>
...
<script>
    ...
    const namaKerja = document.forms["myForm"]["barang"].value.trim();
    const jenisDivisi = document.forms["myForm"]["jenis"] ? document.forms["myForm"]["jenis"].value.trim() : "";
    const satuanKerja = document.forms["myForm"]["satuan"] ? document.forms["myForm"]["satuan"].value.trim() : "";

    if (namaKerja === "" || jenisDivisi === "" || satuanKerja === "") {
        Swal.fire({
            icon: 'warning',
            title: 'Data tidak boleh kosong!',
            text: 'Pastikan data sudah diisi.',
    ...
    return true; // Lanjut submit jika semua field terisi
}
