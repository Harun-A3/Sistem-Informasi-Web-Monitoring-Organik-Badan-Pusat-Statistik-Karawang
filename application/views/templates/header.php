...
<head>
    ...
    <title>MONITORING ORGANIK </title>
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>home">
                <div class="sidebar-brand-icon ">
                    <img src="<?= base_url(); ?>assets/icon/bps.png" width="50">
                </div>
                <div class="sidebar-brand-text mx-3 ">MONITORING ORGANIK</div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Kerja</h6>
                        <?php if($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'gudang'): ?>
                        <!-- sebelumnya satuan -->
                            <a class="collapse-item" href="<?= base_url() ?>satuan"><b>Satuan Pekerjaan</b></a>
                        <!-- sebelumnya jenis -->
                            <a class="collapse-item" href="<?= base_url() ?>jenis"><b>Jenis Divisi</b></a>
                        <?php endif; ?>
                        <!-- sebelumnya barang -->
                        <a class="collapse-item" href="<?= base_url() ?>barang"><b>Data Pekerjaan</b></a>
                    </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Riwayat Kerja</h6>
                        <a class="collapse-item" href="<?= base_url() ?>barang_masuk"><b>Riwayat Kerja</b></a>
            ...
            <?php if($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'organik'): ?>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url() ?>lap_barang_masuk"><b>Laporan Riwayat Kerja</b></a>
