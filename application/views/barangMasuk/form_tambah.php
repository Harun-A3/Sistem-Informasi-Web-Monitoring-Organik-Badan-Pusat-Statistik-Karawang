    ...
    <form action="<?= base_url() ?>barangMasuk/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div class="d-sm-flex">
                ...
                &nbsp;
                <h1 class="h2 mb-0 text-gray-800">Tambah Riwayat Kerja</h1>
            </div>
            ...
            <div class="col-lg-8 mb-4">
                ...
                <div class="card border-bottom-secondary shadow mb-4">
                    <div class="card-header py-3 bg-secondary">
                        <h6 class="m-0 font-weight-bold text-white">Form Riwayat Kerja</h6>
                    </div>
                    <div class="card-body">
                        <div class="col-lg-12">

                            <!-- ID Transaksi -->
                            <div class="form-group"><label>ID Riwayat Kerja</label>
                            ...
                            <!-- opsi kerja -->
                            <?php if($jmlbarang > 0): ?>
                            <div class="form-group"><label>Kerja</label>
                            ...
                            <div class="form-group"><label>Kerja</label>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <span class="text-danger"><i>(Belum Ada Data Kerja!)</i></span>
                            ...
                            <div class="form-group"><label>Organik</label>
                            ...
                            <div class="form-group"><label>Organik</label>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <span class="text-danger"><i>(Belum Ada Data Organik!)</i></span>
                            ...
                            <div class="form-group"><label>Volume</label>
                                <input class="form-control" name="volume" type="number" placeholder="">
                            </div>

                            <!-- Realisasi -->
                            <!-- <div class="form-group"><label>Realisasi</label>
                                <input class="form-control" name="jmlmasuk" type="number" placeholder="">
                            </div> -->
...
<script>
    ...
    const tglMasuk = document.forms["myForm"]["tgl"].value.trim();
    const barang = document.forms["myForm"]["barang"] ? document.forms["myForm"]["barang"].value.trim() : "";
    const supplier = document.forms["myForm"]["supplier"] ? document.forms["myForm"]["supplier"].value.trim() : "";
    const volume = document.forms["myForm"]["volume"].value.trim();

    if (tglMasuk === "" || barang === "" || supplier === "" || volume === "") {
        Swal.fire({
            icon: 'warning',
            title: 'Data belum lengkap!',
            text: 'Silakan isi data.',
    ...
    return true; // Lanjutkan submit jika semua terisi
}
